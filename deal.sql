...
CREATE DATABASE IF NOT EXISTS `leanapp` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `leanapp`;
...
INSERT INTO `candidates` (`id`, `avatar`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`, `linkedin`, `biography`, `github`) VALUES
	(14, 'https://pbs.twimg.com/profile_images/961897996509237248/PGcmxUkD_400x400.jpg', 'kweku mensah', 'kweku@gmail.com', '$2y$10$8F8v4Ox7GSmbRu7N6PRQ6OylJ4GrtWeDgwgXOcFYswFAJ54Fn9AEK', 'iJMBQtP7gO4t6Xcf1Hugy7Gjb11ZCnYCwc4PPgyLahcS26u87YyJvN1mzt26', '2018-07-27 15:08:51', '2018-08-07 19:22:09', 'dennis ruhiu', 'Kweku mensah has a bsc. in computer engineering and spent three years developing custom data processing and analysis programs for mlima. He specializes in scalable, enterprise-level application development and engineering solutions for exceptionally high thro', 'robertruhiu'),
...
INSERT INTO `users` (`id`, `name`, `company`, `updated_at`, `remember_token`, `created_at`, `email`, `password`) VALUES
	(21, 'dennis ruhiu', 'codeln', '2018-07-28 17:16:03', 'DpyZ5UKgXCWtz7xLzwsjHpqP8iVcJqFDDI9ZyGTi7onA7Fs1dJw5ZMmbHkhN', '2018-07-28 17:16:03', 'robertruhiu@gmail.com', '$2y$10$Nv.rnx2BT/m9oHehWJQpMOb0uWH9a8a3Iqqu20sHw9tvN/us1ElBG'),
