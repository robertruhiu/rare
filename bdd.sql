...
-- Dumping data for table multiaccount.candidates: ~6 rows (approximately)
...
-- Dumping data for table multiaccount.candidate_stores: ~5 rows (approximately)
...
-- Dumping data for table multiaccount.casestudies: ~3 rows (approximately)
...
-- Dumping data for table multiaccount.password_resets: ~1 rows (approximately)
...
-- Dumping data for table multiaccount.skills: ~18 rows (approximately)
...
-- Dumping data for table multiaccount.typeassessments: ~4 rows (approximately)
