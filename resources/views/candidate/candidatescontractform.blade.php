            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="post" action="{{ route('candidate.candidatescontractform') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <input type="hidden" class="form-control" id="candidate_id" name="candidate_id" value="{{ Auth::user()->id }}">
                                </div>
                                <div class="form-group">
                                    <label for="category_id">Type Offer</label>
                                    <select class="form-control" name="typecontract_id">
